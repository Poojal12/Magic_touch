...
if($_GET['delid']){
    ...
    echo "<script>window.location.href='acceptedappoint.php'</script>";
              }
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="color:red;">Accepted Appointments</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped" style="text-align:center;">
                            ...
                            <tbody>
                                <?php
                                $s="select * from tblbook where Status='Selected'";
